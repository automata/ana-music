...
compositores = ['scarlatti', 'mozart', 'beethoven']
...
plt.xticks(range(len(inovacao)), [r'Scarlatti $\rightarrow$ Mozart',
...
dialabels = [r'Scarlatti $\rightarrow$ Mozart $\rightarrow$ Beethoven']
